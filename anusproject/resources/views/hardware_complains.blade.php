...
<html lang="en">
  <head>
    <title>Hardware Complains</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
...
<br><br><br>
  ...
  <div class="container">
  <h1 class="text-center" style="color:white;">Hardware Complain View</h1><br>
      ...
      <div class="table-responsive">
        ...
        <thead>
            <tr>
              ...
              <th style="border:1px solid white;">Complain_Category</th>
              <th style="border:1px solid white;">Complain_Description</th>
              <th style="border:1px solid white;">Date_of_Complain</th>
              <th style="border:1px solid white;">Regiystered_By</th>
              <th style="border:1px solid white;">Lab_id</th>
              <th style="border:1px solid white;">Pc_ip</th>
    ...
    {      
      ...
      $.ajax({
          ...
          success:function()
          {
            ...
            window.location="/hardware_compalins";
          },
          error:function()
          {
            alert("Error found");
