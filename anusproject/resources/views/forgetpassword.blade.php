		...
		<div class="row">
			...
			<br>
				...
				<div class="row">
					...
					<div class="col-md-5">
						<button class="btn btn-primary" type="submit" style="width:18rem; font-weight:bold; height:5rem; width:25rem; border-radius:2rem; color:white; font-size:2.5rem;">Forgot Password</button>
