...
<br>
<center>
  <h1 style="color:white;">View Complains</h1>
</center>
  <br>
    <div class="container" >
      <div class="row">
...
<table class="table table-bordered table-hover table-striped" style="color:white; font-size:1.5rem;">
      <thead>
        <tr>
      ...
      @foreach($view_compl as $vc)
      <tbody>
        <tr>
          <td class="text-center">{{$vc->Complain_Category}}</td>
          ...
          <td class="text-center">
            ...
            <div class="cat history">
              <label>
                <a class="btn btn-primary" style="background-color:red; color:white;"><input type="checkbox" value="{{$vc->id}}">unActive</a>
              </label>
              </div>
            @else
              <div class="cat reality">
              <label>
                <a class="btn btn-danger" style="background-color:green; color:white"><input type="checkbox" checked value="{{$vc->id}}">Active</a>
              </label>
              </div>
            @endif
          </td>
