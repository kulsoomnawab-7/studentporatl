	...
	<div class="container-fluid">
		<div class="row">
			...
			<br>
				...
				<br><br>
					<label class="mt-5" for="frm-login-uname" style="font-weight:bold; color:black; margin-left:25px; font-size:2.2rem;">Please Provide Email Address</label><br><br>
					<div class="row">
			...
			<br>
				...
				<div class="row">
					...
					<div class="col-md-5">
						<button class="btn btn-primary" type="submit" style="width:18rem; font-weight:bold; height:5rem;	width:17rem; border-radius:2rem; color:white; font-size:2.5rem;">Register</button>
					...
					<div class="row">
						<div class="col-md-4"></div>
						<div class="col-md-6">
						<span style="font-size:1.8rem; color:black;">Have already an account?</span><a href="/login" style="font-size:1.8rem; color:black;"> Login here</a>
						</div>
					</div>
				@if(session('succdess'))
