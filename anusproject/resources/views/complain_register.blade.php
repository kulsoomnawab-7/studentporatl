      ...
      <div class="container">
        <div class="row">
          <div class="col-md10 offset-md-2">
            <h1 for="" style="color:white;">Selected Lab {{$sf->Lab_id}} <span style="margin-left:20px;">Selected Host Name {{$sf->Host_Name}}<span></h1>
          </div>
        </div>
      </div>
      @endforeach
                ...
                <label for=""><h5>Select Hardware Issues</h5></label>
                    <select class="form-control" name="hardware" id="" required>
                      ...
                      @foreach($hardware as $hard)
                        <option value="{{$hard->hardware_name}} "> 
                            {{ $hard->hardware_name }} 
                        </option>
                      @endforeach    
                    </select>
                  ...
                  <br>
                    ...
                    <label class="btn btn-primary">
                      <input type="checkbox" name="status"  value="1">Working
                    </label> 
                </div>
          ...
          <div class="col-md-6 mt-5">
            ...
            <div class="modal fade" id="modelId2" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
              ...
              @csrf
                  ...
                  <br>
                  <label for=""><h5>Other Type of Software Issues</h5></label>
